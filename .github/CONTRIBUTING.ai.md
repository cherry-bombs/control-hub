> [!WARNING]
> This file is *LLM generated* by *GPT-5.6 Sol.* It serves as a reference alternative while we make the human authored file more robust, as can be seen here: [CONTRIBUTING.md](/.github/CONTRIBUTING.md).
